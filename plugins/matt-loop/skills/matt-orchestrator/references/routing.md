...
| Signal | Skill | Orca role | Parallel guidance |
| --- | --- | --- | --- |
...
| Branch or work-in-progress needs review | `$code-review` | Standards-axis and Spec-axis review tasks | Run the two axes as separate review-only Orca tasks after implementation. |
