...
If the user explicitly chooses to publish a PRD or issues, hand the ready conversation/spec to `$to-prd` or `$to-issues`; those external writes are not implicit.
